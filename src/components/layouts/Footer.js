...
function Footer() {
  return (
    <footer className="text-white-100 bg-[#d7615b]">
      <div className=" container mx-auto text-white flex flex-wrap p-3 flex-col md:flex-row items-center">
        ...
        >
          <Image alt="Navbar Logo" src={"/MainIcon.svg"} width={60} height={60} />
          <p className="leading-5 text-xl mx-2">Indian Food</p>
        </Link>
        <p className="text-sm text-gray-100 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          Copyright © 2024 Indian Food
        </p>
      </div>
    </footer>
  );
